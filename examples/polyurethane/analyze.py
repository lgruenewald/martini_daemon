...
from martini_daemon.old_helpers.monomer import read_monomer_graph, generate_mapping, loop_analysis
...
print("finding loops")
loops = loop_analysis(n_monomer, monomer_data, max_loop=8, progress=True)

...
Simulations in Martini Daemon are run using python run scripts. These contain calls to Martini Daemon’s API,
...
This bond can be any of the types in ``[bonds]``, or a constraint.

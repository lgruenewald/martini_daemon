...
from .old_meta import alias
from .old_gro_file import read_gro
from .utils import backup_try, format_time
from .old_reporters.checkpoint_reporter import load_checkpoint
from .old_components.daemon_integrator import DaemonIntegrator
import sys
import openmm as mm
import logging
...
from .old_xyz_file import read_xyz
...
class Simulation():
    ...
    def __init__(
        ...
        old_reporters -> list of Reporters

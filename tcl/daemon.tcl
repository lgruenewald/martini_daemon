...
proc daemon_bonds { npy {molid 0} } {
	...
	puts "daemon_bonds: vmd_frame trace (version 2) added."
	adj_bonds a a a
}

# BELOW:
# This is the old Tcl version that is no longer updated and may be removed.
...
s 	# number of atoms, assumed to be costant
...
proc daemon_bonds_tcl {npy {molid 0}} {
	global vmd_frame
	global all_bonds
	set all_bonds_tcl [ decode_compressed $npy ]
